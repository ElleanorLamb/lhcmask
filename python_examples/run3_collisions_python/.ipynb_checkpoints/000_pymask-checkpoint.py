...
if track_from_b4_mad_instance:
    mad_track = mad # just changed this to skip the b4 
else:
    mad_track = mad
...
#mad_track.input("call, file='tools/rematchCOIP.madx';") # changed
...
# saving survey and the twiss for the debug before the xtrack line is generated 
sdf = mad_track.survey().dframe()
sdf.to_pickle('beam1_survey_sext.pkl')
tdf = mad_track.table.twiss.dframe()
sdf.to_pickle('beam1_twiss_sext.pkl')  
sumdf = mad_track.get_summ_df('summ')
sumdf.to_pickle('beam1_summ.pkl')    
...
# saving survey and the twiss for the debug
tfs = mad_track.survey().dframe()
tfs.to_pickle('beam1_survey_sext.pkl')
tfs = mad_track.table.twiss.dframe()
tfs.to_pickle('beam1_twiss_sext.pkl')  
